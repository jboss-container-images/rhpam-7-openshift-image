...
Feature: Verify if MariaDB Extension image was correctly built.
  ...
  Scenario: Verify if the correct correct files are present in the container and if its content are correct
    ...
    And file /extensions/modules/org/mariadb/main/module.xml should exist
    And file /extensions/install.properties should contain DRIVERS=MARIADB
    And file /extensions/install.properties should contain MARIADB_DRIVER_NAME=mariadb
    And file /extensions/install.properties should contain MARIADB_DRIVER_MODULE=org.mariadb
    ...
    And file /extensions/modules/org/mariadb/main/module.xml should contain <module xmlns="urn:jboss:module:1.5" name="org.mariadb">
