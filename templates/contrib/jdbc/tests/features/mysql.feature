...
Feature: Verify if MySQL Extension image was correctly built.
  ...
  Scenario: Verify if the correct correct files are present in the container and if its content are correct
    ...
    And file /extensions/modules/com/mysqlCustom/main/module.xml should exist
    And file /extensions/install.properties should contain DRIVERS=MYSQL
    And file /extensions/install.properties should contain MYSQL_DRIVER_NAME=mysqlCustom
    And file /extensions/install.properties should contain MYSQL_DRIVER_MODULE=com.mysqlCustom
    ...
    And file /extensions/modules/com/mysqlCustom/main/module.xml should contain <module xmlns="urn:jboss:module:1.5" name="com.mysqlCustom">