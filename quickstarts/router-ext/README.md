...
Note: this is the development branch, the target images might not be available here, instead you can look at the [release branch](https://github.com/jboss-container-images/rhpam-7-openshift-image/tree/7.14.x/quickstarts/router-ext)
...
After building the Smart Router extension, you can prepare the environment to extend the `registry.redhat.io/rhpam-7/rhpam-smartrouter-rhel8:7.14.0` image 
...
```bash
$ docker pull registry.redhat.io/rhpam-7/rhpam-smartrouter-rhel8:7.14.0
```
...
```bash
$ docker run --rm registry.redhat.io/rhpam-7/rhpam-smartrouter-rhel8:7.14.0 \
    cat /opt/rhpam-smartrouter/openshift-launch.sh > openshift-launch.sh
```

Check the file content, it should be the same as [this file](https://github.com/jboss-container-images/jboss-kie-modules/blob/rhpam-7.14.0.GA/jboss-kie-smartrouter/added/openshift-launch.sh).
...
```bash
from registry.redhat.io/rhpam-7/rhpam-smartrouter-rhel8:7.14.0
...
Step 1/8 : from registry.redhat.io/rhpam-7/rhpam-smartrouter-rhel8:7.14.0
 ---> 1822bf9d5565
