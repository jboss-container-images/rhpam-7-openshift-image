package org.openshift.quickstarts.rhba.kieserver.library.client;
...
import org.openshift.quickstarts.rhba.kieserver.library.types.Loan;
import org.openshift.quickstarts.rhba.kieserver.library.types.LoanRequest;
import org.openshift.quickstarts.rhba.kieserver.library.types.LoanResponse;
import org.openshift.quickstarts.rhba.kieserver.library.types.ReturnRequest;
import org.openshift.quickstarts.rhba.kieserver.library.types.ReturnResponse;
...
public class LibraryClient {
    ...
    Suggestion getSuggestion(String keyword) {
        ...
        if (appcfg.getKieSession() != null) {
            ...
            ServiceResponse<ExecutionResults> serviceResponse = appcfg.getRuleServicesClient().executeCommandsWithResults("rhba-kieserver-library", batch);
    ...
    Loan attemptLoan(String isbn) {
        ...
        if (appcfg.getKieSession() != null) {
            ...
            Long pid = procserv.startProcess("rhba-kieserver-library", "LibraryProcess", parameters);
            loanResponse = (LoanResponse)procserv.getProcessInstanceVariable("rhba-kieserver-library", pid, "loanResponse");
        }
    ...
    boolean returnLoan(Loan loan) {
        ...
        if (appcfg.getKieSession() != null) {
            ...
            ProcessServicesClient procserv = appcfg.getProcessServicesClient();
            procserv.signalProcessInstance("rhba-kieserver-library", loan.getId(), "ReturnSignal", returnRequest);
            //returnResponse = (ReturnResponse)procserv.getProcessInstanceVariable("rhba-kieserver-library", loan.getId(), "returnResponse");
