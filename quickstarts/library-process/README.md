...
To deploy the Library Process demo you can use the [rhpam72-prod-immutable-kieserver](https://github.com/jboss-container-images/rhpam-7-openshift-image/blob/master/templates/rhpam72-prod-immutable-kieserver.yaml)
...
```bash
oc create -f https://raw.githubusercontent.com/jboss-container-images/rhpam-7-openshift-image/master/templates/rhpam72-prod-immutable-kieserver.yaml -n openshift
