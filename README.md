...
On the root directory you can also find the two files:
 ...
 - [rhpam-image-streams.yaml](rhpam710-image-streams.yaml): imagestreams definitions, file used to install the product image streams on OpenShift, this files contains the image stream name and the registry the image will be pulled of.
